...
class ModelTraining:
    ...
    def train_lgbm(self, X_train, y_train):
        try:
            ...
            logger.info("Starting out Hyperparameter training")
    ...
    def evaluate_model(self, model, X_test, y_test):
        try:
            logger.info("Evaluating out model")
    ...
    def run(self):
        try:
            with mlflow.start_run():
                logger.info("Running the model training pipeline")
                
                logger.info("Starting our MLFLOW experimentation")
                
                logger.info("Logging the training and testing dataset to MLFLOW")
                mlflow.log_artifact(self.train_path, artifact_path="datasets")
                mlflow.log_artifact(self.test_path, artifact_path="datesets")
            ...
            raise CustomException(f"Failed during training model pipeline {e}\n\n")
